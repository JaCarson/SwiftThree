...
//: - Why programmers call text data _strings_.
...
//:
//: Practice what you've learned so far with some additional stringy exercises.
//:
//:[Previous](@previous)  |  page 12 of 16  |  [Next: Making a List](@next)
let baseballs = 5

print I have \(baseballs) \nbaseba

let "I have \(baseBalls)"
