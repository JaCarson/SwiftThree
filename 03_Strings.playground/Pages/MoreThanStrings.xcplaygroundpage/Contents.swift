...
let girlName = "Natalie"

let favoriteActivity = "adventuring"

let favoriteAnimal = "Dogs"

let dogsName = "Hobbs"

let dogsName2 = "Tuffie"

let sampleStory = "\(girlName) loves to go \(favoriteActivity) with her \(favoriteAnimal), \(dogsName) and \(dogsName2)."
